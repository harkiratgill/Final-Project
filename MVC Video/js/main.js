...
function getMovies(searchText){
 //thsi function make the request from to api to get the movie that is serched
...
function movieSelected(id){//this selects the movie id
...
function getMovie(){
  ...
  // this request the movie details from the api
